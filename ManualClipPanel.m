function ManualClipPanel()
    ...
    hText_SaveAs = uicontrol('Parent', hFigureBase, ...
                                     'Style', 'Text', ...
                                     'Units', 'normalized', ...
                                     'Position', [0.87 0.3 0.05 0.05], ...
                                     'String', 'Save As', ...
                                     'FontSize', 14);
    hEdit_SaveAsFileName = uicontrol('Parent', hFigureBase, ...
                                     'Style', 'Edit', ...
                                     'Units', 'normalized', ...
                                     'Position', [0.87 0.29 0.1 0.024], ...
                                     'FontSize', 10, ...
                                     'CallBack', @Edit_SaveAsFileName);
	hButton_Truncate = uicontrol('Parent', hFigureBase, ...
							   'Style', 'pushbutton', ...
							   'Units', 'normalized', ...
							   'FontSize', 10, ...
							   'Position', [0.86 0.20 0.06 0.04 ], ...
							   'String', 'Truncate', ...
							   'CallBack', @Button_Truncate_CallBack);

    % Coder information
    hText_Author = uicontrol('Parent', hFigureBase, ...
                             'Style', 'Text', ...
                             'String', 'Designed by cnzero in China', ...
                             'FontName', 'Arial', ...
                             'FontSize', 8, ...
                             'FontAngle', 'italic', ...
                             'Units', 'normalized', ...
                             'Position', [0.9 0.0 0.1 0.02]);
    ...
    handles.hEdit_SaveAsFileName = hEdit_SaveAsFileName;
...
function Button_AddFile_CallBack(source, eventdata)
    ...
    if Channel_Counts <= 4
        ...
        H = 0.99/Channel_Counts;
        for ch=1:Channel_Counts
            hAxes_EMG(ch) = axes('Parent', handles.hPanelWhole, ...
                                 'Units', 'normalized', ...
                                 'Position', [0.02 1-H*ch, 0.97, H*.9], ...
                                 'YGrid', 'on', ...
                                 'XGrid', 'on', ...
                                 'YLimMode', 'manual');
        ...
        disp('The others in the PanelRight');
        set(handles.hPanelLeft, 'Visible', 'on');
        set(handles.hPanelRight, 'Visible', 'on');
        H = 0.99/ceil(Channel_Counts/2);
        %Left half axes
